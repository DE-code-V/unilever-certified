...
![flow_chart](assests/flow-horizontal.png) <br> <br>
***Final excel file containing predictions is named as `bodywash-test-predictions.xlsx` and is located at the root directory of the project*** <br>
## 1. Approach:
